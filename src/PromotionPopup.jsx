    ...
    return (
        <Wrapper>
            ...
            <Container>
                <IntroContainer>
                    <Button>안내</Button>
                    <Title fontSize={24}>우잉 신규 상품 및 할인 안내</Title>
                    <Explain fontSize={12}>
                        우잉 서비스를 이용해주시는 고객님께 진심으로 감사드립니다. <br></br>
                        우잉을 애용해주시는 고객님을 위한 신규 상품 출시 및 할인 프로모션을 안내드립니다.
                    </Explain>
                </IntroContainer>
                <PeriodContainer>
                    ...
                    <DayText> 2023.07.15 ~ 2023.08.31</DayText>
                </PeriodContainer>
                <PromoContainer>
                    {' '}
                    <TextRowWrapper>
                        <ButtonNum style={{ marginBottom: '5px' }}>01</ButtonNum>{' '}
                        <Title fontSize={22} style={{ color: '#1c9da9', marginBottom: '10px' }}>
                            특별할인
                        </Title>
                        <Title fontSize={22}>프로모션</Title>
                    </TextRowWrapper>
                    <Explain fontSize={11}>
                        우잉을 애용해주시는 고객님을 위한 한시적 프로모션 상품을 출시하였습니다.<br></br>
                        기간 내에 구매 시 특별 할인된 가격으로 서비스를 이용하실 수 있습니다.
                    </Explain>
                    <BoxWrapper>
                        <Box>
                            <BoxColunmWrapper>
                                <NormalTitle fontSize={20} style={{ textAlign: 'left', fontWeight: 'normal' }}>
                                    우잉
                                </NormalTitle>
                ...
                <PromoContainer>
                    ...
                    <Explain fontSize={10}>
                        ...
                        50개 부스이상, 7일 이내 단기로 이용하시는 고객님들께서 더 저렴한 요금제로 이용하실 수 있습니다.
                    </Explain>
                    <BoxWrapper>
                        <Box>
                            <BoxColunmWrapper>
                                ...
                                <BoxColunmWrapper style={{ paddingBottom: 20 }}>
                                    <BoxExplain fontSize={8}>7일 이내 단기 사용, 50개 이상 계정 이용 시</BoxExplain>
                        ...
                        <Box>
                            <BoxColunmWrapper>
                                ...
                                <BoxColunmWrapper style={{ paddingBottom: 20 }}>
                                    ...
                                    <BoxExplain fontSize={10}>대량 건에 대해 25% 할인 적용</BoxExplain>
                                </BoxColunmWrapper>
                                <BoxRowWrapper>
                                    <BoxExplain
                                        fontSize={10}
                ...
                <Title fontSize={12} style={{ paddingBottom: 10 }}>
            ...
            <BottomWrapper>
                <BoxExplain fontSize={12} onClick={handleWeekCheckBox}>
                    {isWeekCheck ? (
                        <svg width="15px" height="15px" viewBox="-2.4 -2.4 28.8 28.8" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#9c9c9c">
                        ...
                        <svg fill="#c4c4c4" width="15px" height="15px" viewBox="-2.4 -2.4 28.8 28.8" xmlns="http://www.w3.org/2000/svg" stroke="#c4c4c4">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
